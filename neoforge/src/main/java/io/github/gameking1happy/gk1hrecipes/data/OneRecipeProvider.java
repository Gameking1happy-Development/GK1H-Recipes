...
public class OneRecipeProvider extends RecipeProvider {
    // Get the parameters from GatherDataEvent.
    public OneRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Items.IRON_INGOT, 2)
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath(MOD_ID, "test1"));
    }
}